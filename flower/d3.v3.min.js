!function(){
	...
	function e(n){
		return{left:function(t,e,r,u){
			...
			{
				var i=r+u>>>1;n(t[i],e)<0?r=i+1:u=i}return r},right:function(t,e,r,u){
					for(arguments.length<3&&(r=0),arguments.length<4&&(u=t.length);u>r;)
					{
	...
	function l(){
		var n=0;
		for(var t in this)t.charCodeAt(0)===ga&&++n;return n
	}function f(){
		for(var n in this)if(n.charCodeAt(0)===ga)return!1;return!0}
	function h(){}
	function g(n,t,e){
		return function(){
	...
	function m(n){
		...
		var e=[],r=new o;return t.on=function(t,u){
			var i,o=r.get(t);
	...
	function x(){for(var n,t=Go.event;
				n=t.sourceEvent;)t=n;return t}
	function M(n){
